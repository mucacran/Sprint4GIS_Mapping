    ...
    lugares.forEach(function (lugar) {
        ...
        var grafico = new Graphic({
            ...
            popupTemplate: {
                title: "{nombre}",
                content:
                    "<div style='max-width:100%;font-family:Arial,sans-serif;line-height:1.35;'>" +
                    "<img src='{imagen}' alt='Imagen de {nombre}' style='width:100%;height:auto;object-fit:cover;border-radius:8px;margin-bottom:10px;' />" +
